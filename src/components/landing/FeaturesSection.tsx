...
import { 
  ...
  Clock, Check, Store, BarChart2, Coins
} from 'lucide-react';
            ...
            {activeTab === 'webhooks' && (
              <>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Webhook Automation</h3>
                    <p className="text-gray-400">Turn TradingView alerts into automated trades</p>
                  </div>
                </div>
                  ...
                  {webhookExamples.map((webhook, index) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-gray-400 text-sm">{webhook.time}</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {activeTab === 'copyTrading' && (
              <>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Copy Trading</h3>
                    <p className="text-gray-400">Follow top traders and copy their success</p>
                  </div>
                </div>
            ...
            {activeTab === 'marketplace' && (
              <>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Signal Marketplace</h3>
                    <p className="text-gray-400">Turn your strategies into passive income</p>
                  </div>
                </div>
              ...
              {activeTab === 'webhooks' ? (
                ...
                <>
                  <div className="glass-panel rounded-xl p-6">
                    ...
                    <div className="text-gray-400">Monthly marketplace volume</div>
                  </div>
                  <div className="glass-panel rounded-xl p-6">
                    <div className="flex items-center space-x-3 mb-2">
